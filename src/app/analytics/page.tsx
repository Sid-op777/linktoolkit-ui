...
const AnalyticsPage: React.FC = () => {
  ...
  // Fetch available links for the dropdown
  ...
  }, [addToast, location.search]); // location.search to re-evaluate if query param changes
  ...
  // Fetch analytics when selectedLinkId changes
  useEffect(() => {
    if (selectedLinkId) {
      ...
      setAnalyticsData(null); // Clear data if no link is selected
    }
