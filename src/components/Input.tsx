...
export const Input: React.FC<InputProps> = ({ label, id, error, Icon, className, ...props }) => {
  const baseInputClasses = "block w-full appearance-none rounded-md border bg-slate-800 px-3 py-2 text-slate-100 placeholder-slate-400 shadow-sm focus:outline-none sm:text-sm";
